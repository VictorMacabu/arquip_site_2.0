...
<body>
    ...
    <div class="banner-estrutura">
        ...
        <div class="texto-banner">
            ...
            <p>O ARQUIP oferece suporte especializado para pesquisadores acadêmicos <br> interessados em acessar e utilizar
                seu acervo, que é uma fonte valiosa de <br> documentos históricos e administrativos do Município de São
                Paulo.
            </p>
        </div>
    ...
    <div class="container-pagina">
        ...
        <div class="card-secao">
            <main>
                ...
                <h2>Como solicitar o acesso ao acervo?</h2>
                ...
                <ol>
                    <li>Acesse o Portal de Processos ARQUIP e faça o login. Utilizamos a SenhaWeb para acesso ao Portal.
                        Caso não possua, siga as orientações em: <a
                            href="https://capital.sp.gov.br/web/fazenda/servicos/senhaweb" target="_blank">https://capital.sp.gov.br/web/fazenda/servicos/senhaweb</a>
                    </li>
                ...
                <p>Em sua área logada no Portal de Processos, você pode realizar consultas aos processos eletrônicos a qual
                    você fez autuação, podendo ver seu último andamento e também visualizar os documentos constituintes
                    destes requerimentos. Além disso, sempre que seu requerimento tiver uma atualização com informação, você
                    será notificado via endereço eletrônico, o mesmo que está em seu cadastro da SenhaWeb, fique atento as
                    notificações.
                </p>
                ...
                <p>Após a compensação do pagamento, o requerimento é recepcionado em nossa unidade. Faremos a validação dos
                    ...
                    o desarquivamento ao nosso Núcleo responsável pelos os trabalhos no acervo. Após o desarquivamento, o
                    processo é redirecionado ao nosso setor de pesquisa, a qual analisaremos os documentos para a
                    confirmação que atende ao que foi solicitado. Adiante, tramitamos os processos selecionado ao setor de
                    preparação para a digitalização, a qual é ordenado, higienizado e desmetalizado (remoção de grampos,
                    bailarinas, colchetes, clipes e similares). É então levado ao setor de digitalização, conferência e
                    autenticação digital. Quando estiver tudo pronto, o setor de atendimento fará a disponibilização do
                    processo via endereço eletrônico e o seu requerimento será finalizado. Fique atento aos e-mails e caixa
                    de SPAM.</p>
                ...
                <p>Após a etapa de digitalização, conforme descrito acima, o processo administrativo físico será convertido
                    para um processo digital. Sendo assim, ele receberá um novo número de protocolo, sem prejuízo do número
                    anterior, e os documentos serão inseridos, seguindo a normas e regulamentos de preservação digital, no
                    Sistema Eletrônicos de Informações. A disponibilização se dará com o envio de link de acesso para
                    visualizar o processo e seus documentos. Fique atento, pois o link de acesso é enviado no endereço
                    eletrônico informado no requerimento e tem validade de acesso. <b>Não perca o prazo!</b></p>
